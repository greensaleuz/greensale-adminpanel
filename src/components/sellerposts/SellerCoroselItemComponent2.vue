  ...
  export default defineComponent({
    ...
    props: {
        ImageList :  { type: Array as () => string[], default: () => [] as string[], }
    },
    watch:
    {
        ImageList:"load"
    ...
    methods: {
      ...
      load() {
       ...
       debugger
        console.log("imagePath:", this.ImageList);
      },
    },
    mounted() {
      this.load();
...
<template>
    <div class="relative w-full" data-carousel="slide">
      <div v-if="ImageList.length == 1">
        <div>
          <img :src="computeImageUrl(ImageList[0])" class="absolute w-full h-full object-cover" alt="" />
