...
<template>
  ...
  >
    ...
    <div class="">
      <div class="flex">
        <div class="my-1"> <icon name="location" class="py-2" style="margin-top:10px;"></icon></div>
      ...
      <h4 class=" text-xl tracking-tight black dark:text-white px-2">{{ price }}UZS  {{ capacity }}{{ capacityMeasure }}</h4>
