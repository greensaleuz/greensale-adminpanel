...
export default defineComponent({
    ...
    methods: {
        ...
        async confirmDelete() {
            ...
            const response = await axios.delete("/api/admin/users/" + this.id);
    ...
    <tbody>
            ...
            style="border-radius: 10px; ">
                ...
                <td class="w-32 px-0 py-4">
                    <button type="button" @click="openUpdateRole" class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900">
                        {{ $t('admin') }}
                    </button>
                </td>
            </tr>
