    ...
    <div class="flex" style="display: flex">
      ...
      >
        <div class="">
          ...
          <p
            class="font-normal text-sm text-gray-700 dark:text-gray-300 px-5"
            style="width: 290px"
          >
            {{ postList.type }}
          </p>
        ...
        <div class="w-96 flex my-3 pt-2" style="gap: 10px; margin-top: auto">
            ...
            <div> <h4 class="text-sm tracking-tight black dark:text-white px-5">
              {{ postList.fullName }}
            </h4>
        ...
        <div class="w-96 flex mb-4 mt-2" style="gap: 10px;">
