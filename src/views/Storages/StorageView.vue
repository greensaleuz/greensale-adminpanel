<template>
    <div class="flex flex-wrap">
        <div role="status" class="w-80 mt-5 mb-5 me-5 mx-5 items-center max-w-sm p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700">
